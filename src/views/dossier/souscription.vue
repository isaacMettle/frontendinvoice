...
export default {
  ...
  mounted() {
    this.fetchsouscription();
  },
  methods: {
    async fetchsouscription() {
      try {
        const response = await axios.get('http://127.0.0.1:8000/api/listSubscription');
              ...
              <BCol sm="8">
                <div class="text-sm-end">
                  <BButton variant="success" class="btn-rounded mb-2 me-2" @click="showCreateModal = true">
                    <i class="mdi mdi-plus me-1"></i> Ajouter une souscription
                  </BButton>
                </div>
              </BCol>
            </BRow>
              ...
              <BTableSimple class="table-centered table-nowrap align-middle">
                <BThead>
                  <BTr>
                    ...
                    <BTh>Prix</BTh>
                    <BTh>Status</BTh>
                    <BTh>Debut d'abonnement</BTh>
                    <BTh>Fin d'abonnement</BTh>
                  </BTr>
                </BThead>
                <BTbody>
